...
def __start__():
    try:
        ...
        url = input(Fore.GREEN+" ┌─["+Fore.BLUE+"IGTOOLS"+"~"+Fore.RED+"@Root"+Fore.WHITE+"/"+"Admin Page Finder"+Fore.GREEN+"""]
 └──╼  """+Fore.WHITE+"$ ").lower()
        print("\n")
...
""").split()
        ...
        for i in list_:
            ...
            if r.status_code == 200:
                print(Fore.GREEN+" [+] "+Fore.WHITE+url+i+Fore.GREEN+"Found")
            else:
                print(Fore.RED+" [-] "+Fore.WHITE+url+i+Fore.RED+"Not Found")
        try:
